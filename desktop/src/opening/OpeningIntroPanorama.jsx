...
export default function OpeningIntroPanorama({ startBgm, onComplete }) {
  ...
  useEffect(() => {
    ...
    const context = gsap.context(() => {
      ...
      gsap.set(".scene-paper", { scale: 1.08, transformOrigin: "center center" });
      gsap.set(".scene-one .scene-art", { opacity: 0, y: 100, scale: 1.18, rotation: index => [-3, 0, 3][index] });
      gsap.set(".scene-two .scene-art", { opacity: 0, y: 110, scale: 1.18, rotation: index => [2, 0, -2][index] });
      gsap.set(".scene-three .scene-art", { opacity: 0, x: index => index === 0 ? -180 : index === 2 ? 180 : 0, scale: 1.12, rotation: index => index === 0 ? -4 : index === 2 ? 4 : 0 });
      gsap.set(".caption-char", { opacity: 0, y: 48, scale: 1.3 }); /* IV: 更大落差 */
      gsap.set(".scene-caption > span", { opacity: 0, y: 18 });
      gsap.set(".scene-glow", { opacity: 0 });
      ...
      timeline
        ...
        /* 场景1: 画作戏剧性入场 + 旋转归位 */
        .to(".scene-one .scene-art", { opacity: 1, y: 0, scale: 1, rotation: 0, duration: 1.1, stagger: 0.14, ease: "back.out(1.8)" }, "reveal+=0.15")
        /* 背景形状大幅呼吸 */
        .to(".scene-one .shape-one", { xPercent: 5.5, yPercent: -4, scale: 0.92, duration: 3.65, ease: "none" }, "reveal")
        .to(".scene-one .shape-two", { xPercent: -5, yPercent: 4, scale: 1.1, duration: 3.65, ease: "none" }, "reveal")
        /* 字幕逐字弹落，参数明显 */
        .to(".scene-one .scene-caption > span", { opacity: 1, y: 0, duration: 0.45, ease: "back.out(1.4)" }, "reveal+=0.75")
        .to(".scene-one .caption-char", { opacity: 1, y: 0, scale: 1, stagger: 0.1, duration: 0.42, ease: "elastic.out(1.4, 0.5)" }, "reveal+=0.88")
        /* 前/后景大幅视差漂移 */
        .to(".scene-one .art-water", { x: -36, y: -16, rotation: -1.8, duration: 2.0, ease: "sine.inOut" }, "reveal+=0.8")
        .to(".scene-one .art-romance", { x: 22, y: 14, duration: 2.0, ease: "sine.inOut" }, "reveal+=0.8")
        .to(".scene-one .art-tower", { x: -14, y: -8, rotation: 1.2, duration: 2.0, ease: "sine.inOut" }, "reveal+=0.8")
        /* I: 镜头感平移 — 轻微压扁后弹开 */
        ...
        .to(".scene-two .scene-art", { opacity: 1, y: 0, scale: 1, rotation: 0, duration: 1.0, stagger: 0.13, ease: "back.out(1.8)" }, "panoramaTwo+=0.18")
        .to(".scene-two .shape-one", { xPercent: -5.5, yPercent: 4, scale: 1.1, duration: 3.65, ease: "none" }, "panoramaTwo")
        .to(".scene-two .shape-two", { xPercent: 5, yPercent: -3.8, scale: 0.9, duration: 3.65, ease: "none" }, "panoramaTwo")
        .to(".scene-two .scene-caption > span", { opacity: 1, y: 0, duration: 0.45, ease: "back.out(1.4)" }, "panoramaTwo+=0.65")
        .to(".scene-two .caption-char", { opacity: 1, y: 0, scale: 1, stagger: 0.1, duration: 0.42, ease: "elastic.out(1.4, 0.5)" }, "panoramaTwo+=0.78")
        .to(".scene-two .art-plum", { x: 32, y: -14, rotation: 1.5, duration: 2.0, ease: "sine.inOut" }, "panoramaTwo+=0.8")
        .to(".scene-two .art-river", { x: -24, y: 16, duration: 2.0, ease: "sine.inOut" }, "panoramaTwo+=0.8")
        .to(".scene-two .art-auspicious", { x: 28, y: -12, rotation: -1.2, duration: 2.0, ease: "sine.inOut" }, "panoramaTwo+=0.8")
        /* I: 镜头感平移 */
        ...
        .to(".scene-three .scene-art", { opacity: 1, x: 0, scale: 1, rotation: 0, duration: 0.82, stagger: 0.09, ease: "back.out(2.5)" }, "panoramaThree+=0.2")
        .to(".scene-three .shape-one", { yPercent: -5, scale: 1.1, duration: 3.1, ease: "none" }, "panoramaThree")
        .to(".scene-three .shape-two", { xPercent: 5, scale: 0.9, duration: 3.1, ease: "none" }, "panoramaThree")
        .to(".scene-three .scene-caption > span", { opacity: 1, y: 0, duration: 0.45, ease: "back.out(1.4)" }, "panoramaThree+=0.7")
        .to(".scene-three .caption-char", { opacity: 1, y: 0, scale: 1, stagger: 0.1, duration: 0.42, ease: "elastic.out(1.4, 0.5)" }, "panoramaThree+=0.83")
        .to(".scene-three .scene-art", { x: index => [-20, 10, 20][index], y: index => [-10, 8, -10][index], duration: 1.8, ease: "sine.inOut" }, "panoramaThree+=1.2")
        .to(".panorama-viewport", {
