...
async function decodeOpeningImages(container) {
...
export default function OpeningIntroPanorama({ startBgm, onComplete }) {
  ...
  useLayoutEffect(() => {
    ...
    const startTimeline = async () => {
      const decoded = decodeOpeningImages(container);
      ...
      <div className="panorama-viewport" aria-hidden="true">
        <div className="panorama-track">
          <section className="panorama-scene scene-one">
            ...
            <img className="scene-art art-water" src="/images/py-014/primary.webp" alt="" loading="eager" decoding="async" fetchpriority="high" />
            <img className="scene-art art-romance" src="/images/py-005/primary.webp" alt="" loading="eager" decoding="async" fetchpriority="high" />
            <img className="scene-art art-tower" src="/images/py-016/primary.webp" alt="" loading="eager" decoding="async" fetchpriority="high" />
          ...
          <section className="panorama-scene scene-two">
            <div className="scene-paper shape-one" />
            <div className="scene-paper shape-two" />
            <img className="scene-art art-plum" src="/images/py-030/primary.webp" alt="" loading="eager" decoding="async" />
            <img className="scene-art art-river" src="/images/py-038/primary.webp" alt="" loading="eager" decoding="async" />
            <img className="scene-art art-auspicious" src="/images/py-095/part-1.webp" alt="" loading="eager" decoding="async" />
            <div className="scene-caption">
              <span>第二幕 · 故事</span>
          ...
          <section className="panorama-scene scene-three">
            <div className="scene-paper shape-one" />
            <div className="scene-paper shape-two" />
            <img className="scene-art guardian-left" src="/images/py-099/part-1.webp" alt="" loading="eager" decoding="async" />
            <img className="scene-art guardian-center" src="/images/py-089/part-1.webp" alt="" loading="eager" decoding="async" />
            <img className="scene-art guardian-right" src="/images/py-099/part-2.webp" alt="" loading="eager" decoding="async" />
            <div className="scene-caption">
              <span>第三幕 · 门神</span>
